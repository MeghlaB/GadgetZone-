...
//       setDeletingId(id);
//       try {
//         // Use the correct endpoint based on your server implementation
//         const response = await axios.delete(`https://gadgetzone-server.onrender.com/carts/${id}`);
...
//         </h2>
//         <p className="max-w-md mb-6 text-center text-gray-600">
//           {error.message || "We couldn't load your cart. Please check your connection and try again."}
//         </p>
//         <button
//           onClick={() => window.location.reload()}
//           className="px-6 py-3 font-medium text-white transition-colors bg-red-600 rounded-lg shadow hover:bg-red-700"
...
//       setClearingAll(true);
//       try {
//         const response = await axios.delete(`https://gadgetzone-server.onrender.com/carts/clear/${user.email}`);
//         return response.data;
//       } catch (err) {
...
//       Swal.fire({
//         title: "Cart Cleared!",
//         text: data.message || "All items have been removed from your cart.",
//         icon: "success",
//         timer: 2000,
//         showConfirmButton: false
//       });
