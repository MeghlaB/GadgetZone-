  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card className="shadow-sm">
          <div className="flex items-center">
            <FileTextOutlined className="text-green-500 text-2xl mr-3" />
            <div>
        ...
        <Card className="shadow-sm">
          <div className="flex items-center">
            <BellOutlined className="text-orange-500 text-2xl mr-3" />
            <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card title="Recent Tasks" className="shadow-sm">
          <ul>
            {tasks.map((task) => (
              <li key={task.id} className="mb-3 p-2 border-b">
        ...
        <Card title="Recent Activity" className="shadow-sm">
          <ul>
            {activityLog.map((log) => (
              <li key={log.id} className="mb-3 p-2 border-b">
                <div className="flex justify-between">
